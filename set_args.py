...
parser.add_argument('-model_names', '--model_names', help='model names', type=str, default='net_no_label-net_only_vessel')

parser.add_argument('-lr_lb','--lr_lb',help='learning rate for lobe segmentation', type=float,default=0.00001)
parser.add_argument('-lr_vs','--lr_vs',help='learning rate for vessel segmentation', type=float,default=0.0001)
parser.add_argument('-lr_lu','--lr_lu',help='learning rate for lung segmentation', type=float,default=0.0001)
...
parser.add_argument('-no_label_dir', '--no_label_dir', help='sub directory of no_label data', type=str, default='LUNA16')
...
parser.add_argument('-ld_rc', '--ld_rc', help='ld_rc', type=int, default=1)
parser.add_argument('-ld_lb', '--ld_lb', help='ld_lb', type=int, default=0)
parser.add_argument('-ld_vs', '--ld_vs', help='ld_vs', type=int, default=1)
parser.add_argument('-ld_lu', '--ld_lu', help='ld_lu', type=int, default=0)
parser.add_argument('-ld_aw', '--ld_aw', help='ld_aw', type=int, default=0)
...
parser.add_argument('-ld_rc_name', '--ld_rc_name', help='ld_rc_name', type=str, default='1598395970_798_lrlb1e-05lrvs0.0001mtscale1netnov-nnlpm0.5nldLUNA16ao0ds0tsp1.4z2.5pps100lbnb18vsnb50nlnb400ptsz144ptzsz96')
parser.add_argument('-ld_lb_name', '--ld_lb_name', help='ld_lb_name', type=str, default='None')
parser.add_argument('-ld_vs_name', '--ld_vs_name', help='ld_vs_name', type=str, default='1598395970_733_lrlb1e-05lrvs0.0001mtscale1netnov-nnlpm0.5nldLUNA16ao0ds0tsp1.4z2.5pps100lbnb18vsnb50nlnb400ptsz144ptzsz96')
...
parser.add_argument('-lb_tr_nb', '--lb_tr_nb', help='lb_tr_nb', type=int, default=18)
