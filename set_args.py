...
parser.add_argument('-model_names', '--model_names', help='model names', type=str, default='net_no_label- net_only_vessel-net_only_lobe')
...
parser.add_argument('-mot_lb', '--mot_lb', help='multi outpt', type=int, default=1)
parser.add_argument('-mot_vs', '--mot_vs', help='multi outpt', type=int, default=1)
parser.add_argument('-mot_lu', '--mot_lu', help='multi outpt', type=int, default=1)
parser.add_argument('-mot_aw', '--mot_aw', help='multi outpt', type=int, default=1)
parser.add_argument('-mot_rc', '--mot_rc', help='multi outpt', type=int, default=1)
