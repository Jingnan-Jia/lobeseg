...
parser.add_argument('-model_names', '--model_names', help='model names', type=str, default='net_only_vessel-net_no_label-net_only_lobe')
...
parser.add_argument('-ds_lb', '--ds_lb', help='Number of Deep Supervisers', type=int, default=2)
...
parser.add_argument('-ao_lb', '--ao_lb', help='Value of Auxiliary Output', type=int, default=1)
